...
################################################################
# This is a generated script based on design: mb_snes
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins gpio_usb_keycode/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins gpio_usb_rst/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net gpio_usb_int_ip2intc_irpt [get_bd_pins gpio_usb_int/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In1]
  ...
  connect_bd_net -net spi_usb_ip2intc_irpt [get_bd_pins microblaze_0_xlconcat/In2] [get_bd_pins spi_usb/ip2intc_irpt]
  ...
  connect_bd_net -net timer_usb_axi_interrupt [get_bd_pins microblaze_0_xlconcat/In0] [get_bd_pins timer_usb_axi/interrupt]
