...
HD_PWD='C:/Users/theox/Desktop/NES_Urbana_777/NES_Urbana_777.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NES_Urbana.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NES_Urbana.tcl -notrace
