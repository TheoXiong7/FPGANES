...
HD_PWD='C:/Users/theox/Desktop/NES_Urbana_777/NES_Urbana_777.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NES_Urbana.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NES_Urbana.tcl
